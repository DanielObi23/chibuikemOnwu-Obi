...
switch ($_REQUEST['name']) {
    ...
    case 'countryDetails':
        ...
        break;
    case 'getAirports':
        $url = "http://api.geonames.org/searchJSON?formatted=true&q=airport&country=" . $_REQUEST['country'] . "&lang=es&username=flightltd&style=full";
        break;
    case 'getCities':
        $url = "http://api.geonames.org/searchJSON?country=" . $_POST['country'] . "&maxRows=1000&featureClass=P&username=daniel456";
        break;
    case 'getHistoricalSites':
        $url = "http://api.geonames.org/searchJSON?formatted=true&q=historical%20site&country=" . $_POST['country']. "&lang=es&username=flightltd&style=full";
        break;
    case 'getMuseums':
        $url = "http://api.geonames.org/searchJSON?formatted=true&q=museum&country=" . $_POST['country']. "&lang=es&username=flightltd&style=full";
        break;
    case 'getMonuments':
        $url = "http://api.geonames.org/searchJSON?formatted=true&q=monument&country=". $_POST['country']. "&lang=es&username=flightltd&style=full";
        break;
    case 'reverseGeocode':
        $lat = $_REQUEST['lat'];
        $lng = $_REQUEST['lng'];
